 ...
 */
class NTFP_Portal_SetPermalinks {
	/**
	 * Set up actions
	 */
	...
	public function add_contextual_permalink_help() {
		...
		$content = '<p>' . __( 'NFTP is a different kind of theme, which means it needs to handle URLs differently than other themes. There is no permalink customization in NFTP, you need to use the "Month and name" setting for posts.', 'foxhound' ) . '</p>';
		...
		$screen->add_help_tab( array(
			'id'      => 'nftp_permalinks_help',
			'title'   => __( 'NFTP Permalinks', 'foxhound' ),
